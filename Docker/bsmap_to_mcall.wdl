...
task trim_fastqs{
    ...
    command {
        ...
        mv *.1_val_1.fq.gz ${sample_id}.trm.fastq.gz
        mv *.2_val_2.fq.gz ${sample_id}.trm.fastq.gz

        #delete unneeded intermediates
        rm *.fq.gz
    ...
    output {
	    ...
	    File fastq2_trimmed = "${sample_id}.trm.fastq.gz"
...
task mcall {
    ...
    #Dont process multimapped: "-F 0x100"
